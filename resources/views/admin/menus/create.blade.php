...
<style>
    ...
    .views-container { margin-top: 20px; }
    .views-list {
    ...
    .view-item:hover { background: rgba(99, 102, 241, 0.1); }
    .view-item.selected {
        background: linear-gradient(90deg, rgba(99, 102, 241, 0.2), transparent);
        border-left: 3px solid #22d3ee;
    }
    .view-name { font-weight: 600; font-size: 14px; }
    .view-workbook { font-size: 12px; color: #64748b; margin-top: 4px; display: flex; align-items: center; gap: 6px; }
    .view-path {
        font-size: 11px; color: #94a3b8; font-family: 'Monaco', 'Consolas', monospace;
        padding: 4px 10px; background: rgba(0,0,0,0.3); border-radius: 6px;
    }
    
    .loading { text-align: center; padding: 40px; color: #94a3b8; }
    .loading i { font-size: 32px; margin-bottom: 14px; display: block; color: #22d3ee; }
    ...
    .site-info {
        ...
        padding: 14px 20px; background: linear-gradient(135deg, rgba(99, 102, 241, 0.1), rgba(34, 211, 238, 0.05));
        border-radius: 12px; margin-bottom: 20px; font-size: 14px;
        border: 1px solid rgba(99, 102, 241, 0.2);
    }
    .site-info i { color: #22d3ee; }
</style>
@endsection
...
<div class="card" style="margin-bottom: 24px;">
    <div class="card-header">
        <div>
            ...
            <p style="font-size: 13px; color: #94a3b8; margin-top: 6px;">Masukkan Site ID lalu klik tombol untuk mengambil daftar dashboard</p>
        </div>
    </div>
    ...
    <div class="form-row" style="margin-bottom: 20px;">
        ...
        <div class="form-group" style="margin-bottom: 0; display: flex; align-items: flex-end;">
            <button type="button" class="btn btn-success" id="btnFetchViews" onclick="fetchTableauViews()" style="height: 50px;">
    ...
    <div id="siteInfo" class="site-info" style="display: none;">
        ...
        <span>Site: <strong id="currentSiteName">-</strong></span>
        <span style="color: #64748b;">|</span>
        <span><strong id="viewCount">0</strong> dashboard ditemukan</span>
    </div>
    ...
    <div id="loadingViews" class="loading" style="display: none;">
        <i class="fas fa-spinner loader-spin"></i>
    ...
    <div id="manualInput" class="info-msg" style="display: none;">
        ...
        <span>Jika tidak bisa mengambil daftar otomatis, Anda bisa input path manual di form bawah.</span>
    </div>
</div>

<div class="card" style="max-width: 700px;">
    <div class="card-header">
        <h2 class="card-title"><i class="fas fa-plus-circle"></i> Form Menu</h2>
    </div>
    ...
    <form action="{{ route('menus.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="icon-list">
                ...
                <div class="icon-item {{ old('icon', 'fas fa-chart-bar') == $icon ? 'selected' : '' }}" onclick="selectIcon('{{ $icon }}')"><i class="{{ $icon }}"></i></div>
                @endforeach
            </div>
...
<script>
    ...
    function fetchTableauViews() {
        ...
        btn.disabled = true;
        btn.innerHTML = '<i class="fas fa-spinner loader-spin"></i> Mengambil...';
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if (data.success && data.views && data.views.length > 0) {
                    ...
                    errorDiv.innerHTML = '<i class="fas fa-exclamation-triangle"></i> <span>' + (data.error || 'Tidak ada dashboard ditemukan.') + '</span>';
            ...
            .catch(err => {
                ...
                errorDiv.innerHTML = '<i class="fas fa-exclamation-triangle"></i> <span>Gagal terhubung: ' + err.message + '</span>';
                errorDiv.style.display = 'flex';
                manualDiv.style.display = 'flex';
            });
    }
